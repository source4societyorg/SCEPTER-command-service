...
function forkFunction (command) {
  command.executeCommand(
    'cd services; git clone ' + addServiceCommand.forkRepository + ' ' + addServiceCommand.serviceName + '; cd ' + addServiceCommand.serviceName + '; git remote rm origin; git remote add origin ' + addServiceCommand.gitRepository + '; git push origin master; cd ../; rm -r ' + addServiceCommand.serviceName + '; git submodule add ' + addServiceCommand.gitRepository + ' ' + addServiceCommand.serviceName,
